...
alias mount-skl='ssh -L 2223:localhost:2224 ***REMOVED*** -t -p 2222 -A ssh -L 2224:localhost:22 ***REMOVED***@skl; sshfs -p 2223 ***REMOVED***@localhost:/home/***REMOVED*** ~/mackenzie/skl'
