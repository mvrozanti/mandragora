...
alias mount-skl='sh -c "sleep 2 && sshfs -p 2223 ***REMOVED***@localhost:/home/***REMOVED*** ~/mackenzie/skl" & ; ssh -L 2223:localhost:2224 ***REMOVED***@***REMOVED*** -p 2222 -A ssh -L 2224:localhost:22 ***REMOVED***@skl'
