...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=231       # white on green (2)
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=0      # black on yellow (3)
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=231   # white on green (2)
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=0    # black on yellow (3)
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=0       # black on grey (8)
