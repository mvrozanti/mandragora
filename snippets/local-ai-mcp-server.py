...
TOOLS = [
    ...
    },
    {
        "name": "ask_deepseek",
        "description": (
            "Ask the local DeepSeek R1 32B Uncensored model running on Ollama. "
            "Use for: complex logic, coding, unfiltered responses, and deep reasoning."
        ),
        "inputSchema": {
            "type": "object",
            "properties": {
                "prompt": {
                    "type": "string",
                    "description": "The prompt or question to send to DeepSeek",
                },
                "system": {
                    "type": "string",
                    "description": "Optional system prompt to guide DeepSeek's behavior",
                },
            },
            "required": ["prompt"],
        },
    ...
    for raw in sys.stdin:
        ...
        if method == "initialize":
            ...
            if name == "ask_gemma":
                ...
                model = "huihui_ai/deepseek-r1-abliterated:32b-qwen-distill"
            else:
