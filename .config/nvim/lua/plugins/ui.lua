  ...
  -- ── lualine: replaces vim-airline ──────────────────────────────────────────
  {
    ...
    config = function()
      ...
      local function apply_colors()
        ...
        hi(0, 'FlashLabel',   { ctermfg = 234, ctermbg = 220, bold = true })
        hi(0, 'FlashMatch',   { ctermfg = 231, ctermbg = 237 })
        hi(0, 'FlashCurrent', { ctermfg = 234, ctermbg = 214, bold = true })
        hi(0, 'FlashPrompt',  { ctermfg = 231, ctermbg = 234 })
