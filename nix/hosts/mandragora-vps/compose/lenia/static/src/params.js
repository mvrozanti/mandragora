...
export function createParams(species, overrides = {}) {
  ...
  params.mod = { mu: 0, height: 1, glow: 1, bloom: 1, separation: 1, edge: 1, exposure: 1, nutrient: 0, starve: 0, channelDrive: [0, 0, 0] };
  params.resetMod = () => Object.assign(params.mod,
    { mu: 0, height: 1, glow: 1, bloom: 1, separation: 1, edge: 1, exposure: 1, nutrient: 0, starve: 0 });
