...
Snapshot of oracle (Oracle Cloud aarch64 VM) as it stood on 2026-04-29, prior to the planned NixOS migration. Source of truth for what `nix/hosts/mandragora-vps/` must reproduce or what must be backed up before the migration.
