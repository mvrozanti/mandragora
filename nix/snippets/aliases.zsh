...
alias cfw='v /etc/nixos/mandragora/nix/modules/user/waybar.nix'
alias cfm='v /etc/nixos/mandragora/nix/modules/user/home.nix'
alias cfl='v /etc/nixos/mandragora/nix/modules/user/yazi.nix'
...
alias cfpa='v /etc/nixos/mandragora/nix/modules/user/zsh.nix'
...
_cf_aliases() {
    ...
    configs=(
        ...
        'cfl:yazi file manager config (Nix module)'
...
alias claude='claude'
alias gemini='/run/current-system/sw/bin/gemini -y'
alias qwen='/run/current-system/sw/bin/qwen -y'
